...
```json
{
  "total_return": {
    "value": "-0.0032",
    "interpretation": "총 수익률이 -0.0032라는 것은 백테스트 기간 동안 포트폴리오가 0.0032의 손실을 기록했음을 의미합니다."
  },
  "max_drawdown": {
    "value": "-0.0049", 
    "interpretation": "최대 낙폭이 -0.0049라는 것은 포트폴리오가 겪은 가장 큰 하락이 0.0049였음을 의미합니다."
  }
}
```

**주의**: 들어오는 값 자체가 이미 비율입니다. 백분위 변환을 생각하지 말고 그대로 해석하세요.

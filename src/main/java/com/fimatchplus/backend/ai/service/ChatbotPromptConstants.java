...
public class ChatbotPromptConstants {
    ...
    public static final String BENCHMARK_PROMPT = """
            ...
            답변 원칙:
            1. 제공된 포트폴리오 구성 정보가 있다면 반드시 참고하여 구체적인 분석 제시
            2. 포트폴리오 종목별 비중과 대형주/중소형주 비중을 분석하여 적절한 벤치마크 추천
            3. 단순한 지수 설명이 아닌 실제 선택 방법론과 구체적인 이유 제시
            4. 투자자 상황에 맞는 맞춤형 조언 제공
            5. 벤치마크 선택의 이유와 근거를 포트폴리오 구성에 기반하여 명확히 설명
            6. 한국어로 300자 이내로 간결하게 작성
            """;
